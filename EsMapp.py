...
client = OpenAI(
    api_key=os.environ.get("OPENAI_API_KEY", "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"),  # Will use environment variable if available
